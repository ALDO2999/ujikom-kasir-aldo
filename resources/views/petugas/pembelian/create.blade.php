<x-layout>
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('petugas.pembelian.create') }}">Tambah Penjualan</a></li>
                    ...
                    <div class="col-md-6">
                        <form action="{{ route('petugas.pembelian.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="amount-paid" name="amount_paid" placeholder="Masukkan jumlah bayar">
