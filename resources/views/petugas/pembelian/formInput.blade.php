<x-layout>
    <section class="section">
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('petugas.pembelian.index') }}">Daftar penjualan</a></li>
        ...
        <div class="fixed-bottom bg-white p-3 shadow-lg d-flex justify-content-center">
            <a href="{{ route('petugas.pembelian.create') }}" id="btn-selanjutnya" class="btn btn-secondary px-4 py-2" disabled>Selanjutnya</a>
        </div>
